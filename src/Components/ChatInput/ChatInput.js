...
function ChatInput({ onSendImage, onUploadedImage, onPredictButtonClick, onPredicting }) {
    ...
    return (
        <div className="chat-input-container">
            ...
            <div className="placeholder_image_input">
                <p >UPLOAD AN IMAGE USING THE DESIGNATED ICON AND UPLOAD IT BY CLICKING THE 'UP ARROW' ICON.</p>
            </div>
            <button onClick={onPredictButtonClick} className="send-button" disabled={!onUploadedImage} style={{ cursor: (onUploadedImage) ? 'pointer' : 'not-allowed' }}>
